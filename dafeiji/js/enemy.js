...
//	this.score = 10; //敌机的分数
//	this.Enemy_Type_Large= 1;  //大型飞机
//	this.Enemy_Type_Middle= 2; //中型飞机
//	this.Enemy_Type_Small= 3; //小型飞机
//	
//	this.Enemy_Speed_Large= 3; //大型飞机的速度
//	this.Enemy_Speed_Middle= 5; //中型飞机的速度
//	this.Enemy_Speed_Small= 8; //小型飞机的速度
//	
//	this.Enemy_Hp_Large= 8; //大型飞机的血量
//	this.Enemy_Hp_Middle= 3; //中型飞机的血量
//	this.Enemy_Hp_Small= 1; //小型飞机的血量
//	}
//	
//	init(type){
//		console.log(type);
